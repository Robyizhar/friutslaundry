...
@component('component.form')
    ...
    <div class="form-group mb-3">
        ...
        <input value="{{ !isset($data['detail']) ? old('no_telepon') : old('no_telepon', $data['detail']->no_telepon) }}" type="text" name="no_telepon" class="form-control mb-2 @error('no_telepon') is-invalid @enderror" placeholder="no_telepon" autocomplete="off"/>
