                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3" style="display:none;">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="selectize-pelanggan" name="pelanggan" tabindex="-1" class="selectized" style="display: none;" value="member">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input readonly type="text" class="form-control data-pelanggan first-outlet" id="alamat" name="alamat" value="{{ $info->alamat }}">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="no_handphone">No Handphone</label>
                                            <div class="col-md-9">
                                                <input readonly type="text" class="form-control data-pelanggan first-outlet" id="no_handphone" name="no_handphone" value="{{ $info->phone }}">
                                            </div>
                                        </div>
                                        {{-- <div class="form-group row mb-3">
